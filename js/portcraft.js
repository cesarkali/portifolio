    ...
    const PROJECTS = [
        {
            ...
            highlights: [
                'Ecossistema completo em produção: web e Android nativo sobre a mesma base Firebase, cobrindo o ciclo financeiro inteiro, do lançamento e da baixa ao parcelamento e ao BI.',
                ...
                'Código proprietário, com repositório showcase público para apresentação do produto.',
            ],
        ...
        },
        {
            ...
            highlights: [
                'Transforma o trabalho invisível de um PM em evidência: o tempo registrado vira dashboard e PDF que sustentam decisão de prioridade e de carga de trabalho.',
        ...
        },
        {
            ...
            highlights: [
                'Cobre a operação inteira de um restaurante em um só sistema: o pedido entra pelo cardápio ou pelo totem e segue até o KDS e o caixa, eliminando a digitação manual entre salão e cozinha.',
        ...
        },
        {
            ...
            highlights: [
                'Elimina a digitação em qualquer campo do sistema: ditado global no Windows e no Ubuntu, com transcrição rodando offline.',
        ...
        },
        {
            ...
            desc: 'Bancada de testes para validar scripts em HTML antes de levá-los a um produto com nome próprio.',
            tags: ['HTML'],
            highlights: ['Ambiente isolado para prototipar e validar scripts antes da produção.'],
            stackFull: 'HTML',
            created: '2026-05-28',
        },
        {
