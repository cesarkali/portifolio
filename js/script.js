...
(function () {
    ...
    const PROJECTS = [
        ...
        {
            id: 'pmtt', name: 'PMTT', sub: 'Product Manager Time Tracker', category: 'saas',
        ...
        {
            id: 'controle-pedidos', name: 'Eatz', sub: 'Cardápio Digital & Painel de Gestão', category: 'saas',
            icon: 'fa-solid fa-utensils', visibility: 'private', repoSlug: null,
            deploy: 'https://cardapio.caliberda.com.br',
            desc: 'Sistema completo para restaurantes: cardápio digital multi-tenant e painel de gestão com pedidos, delivery, KDS e caixa, integrado a uma API própria.',
            tags: ['Next.js 16', 'React 19', 'NestJS', 'PostgreSQL'],
            highlights: [
            ...
            stackFull: 'Next.js 16 · React 19 · TS 5.7 · Tailwind 4 · shadcn/ui · Sonner · jose (JWT) · NestJS + PostgreSQL (API)',
            created: '2026-06-24',
        },
        {
        ...
        {
            id: 'eatz-tablet-flutter', name: 'Eatz Tablet', sub: 'Flutter', category: 'saas',
            icon: 'fa-solid fa-mobile-screen', visibility: 'private', repoSlug: null,
            deploy: null,
            desc: 'Totem de autoatendimento em Flutter, para tablets e totens de 7 a 10 polegadas, com vínculo por QR Code e customização avançada de produtos.',
            tags: ['Flutter', 'Dart', 'Riverpod', 'Dio'],
            highlights: [
                'Wizard com vínculo por QR Code ou por ID manual, com modo mock offline.',
                'Cálculo dinâmico de customização de produtos e acompanhamento do status do pedido.',
                'Modo imersivo com bloqueio nativo de quiosque, painel admin por PIN e identificação por NFC.',
                'Arquitetura organizada por feature; compila também para Web.',
            ],
            stackFull: 'Flutter (Dart) · Riverpod v2 · Dio · SharedPreferences · build_runner · Web (WASM)',
            created: '2026-05-25',
        },
        {
        ...
        },
        {
            ...
            deploy: 'https://teste-otelia.vercel.app',
            desc: 'Página de teste usada como ambiente de prototipagem, para validar ideias antes de virarem um produto com nome próprio.',
            tags: ['HTML'],
            highlights: ['Ambiente de prototipagem rápida, sem compromisso de produção.'],
            stackFull: 'HTML',
            created: '2026-05-28',
        },
        {
